...
namespace WebAPI.Validators
{
    public class SituacaoValidator : AbstractValidator<Situacao>
    {
        ...
        public SituacaoValidator(ISituacaoService service)
        {
            _service = service;
            ...
            RuleFor(x => x.Nome)
                ...
                .Must(BeUnique).WithMessage(string.Format(Resources.MustBeUnique, "O Nome da Situação"));
        }

        private bool BeUnique(Situacao entity, string nome)
        {
